...
|            |                                                   |
| =C-M-a=    | Jump to the end of the previous bracket in scope  |
| =C-M-d=    | Jump to the start of the next bracket in scope    |
| =C-M-f=    | Jump to matching closing bracket                  |
| =C-M-b=    | Jump to matching opening bracket                  |
| =C-M-k=    | Kill in bracket region (when cursor over bracket) |
| =C-M-w=    | Copy in bracket region (when cursor over bracket) |
| =M-delete= | Delete previous brackets                          |
