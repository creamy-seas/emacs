...
For a nice pyplot experience, copy over the [[./my-files/python/my_pyplot.mplstyle]] file into your python folder and run
...
#+BEGIN_SRC emacs-lisp
  (defvar my/python/default-venv)
  (setq my/python/default-venv "~/.config/python_vi/pro_vi")
 #+END_SRC
* External setup
...
| =jedi=     | documentation                                             |                     |
| =flake8=   | code checking                                             | worse than =pylint= |
|------------+-----------------------------------------------------------+---------------------|
...
#+BEGIN_SRC emacs-lisp
 ...
 #+END_SRC
* PACKAGE Autopep8
Automatically fix syntax errors upon saving. Uses =flake8=
#+BEGIN_SRC emacs-lisp
...
#+BEGIN_SRC emacs-lisp
 ...
 #+END_SRC
** Default venv
(my/python/activate-venv my/python/default-venv)
* Functions
** =my/python/interrupt=
#+BEGIN_SRC emacs-lisp
