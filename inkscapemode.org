...
(defvar my/drawio/generate-script (concat doom-user-dir "my-scripts/inkscape/drawio_generate.sh"))
(defvar my/drawio/template-file (concat doom-user-dir "my-scripts/inkscape/drawio_template.drawio"))
...
#+BEGIN_SRC emacs-lisp
  ...
  There is a lot of file name preparation - I decided to keep the bash script as clean as possible so evaluate file paths here"
    (let* (
           ...
           (file-path (concat inkscape-dir-path "/" filename))
           (inkscape-process-name (concat "DrawioGenerating:" filename)))
...
#+BEGIN_SRC emacs-lisp
  ...
  (defhydra hydra-inkscape-org (
    ...
    "
        ...
        [_d_] Drawio image                        [_D_] Load drawio image
        [_k_] Kill single inkscape process        [_K_] Kill ALL inkscape processes
