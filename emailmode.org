...
[general]
accounts = vgoptics, ilya_DREAMSAI, ilya_OUTLOOK, ilya_NTLWORLD, yandex, ilya_GMAIL
...
oauth2_client_id_eval=read_config_file("ilya.antonov@dreams-ai.com")["client_id"]
oauth2_client_secret_eval=read_config_file("ilya.antonov@dreams-ai.com")["client_secret"]
...
auth_mechanisms=XOAUTH2
oauth2_request_url=https://accounts.google.com/o/oauth2/token
oauth2_client_id_eval=read_config_file("antonov.ilya225@gmail.com")["client_id"]
oauth2_client_secret_eval=read_config_file("antonov.ilya225@gmail.com")["client_secret"]
...
oauth2_client_id_eval=read_config_file("ilya.antonov@rhul.ac.uk")["client_id"]
oauth2_client_secret_eval=read_config_file("ilya.antonov@rhul.ac.uk")["client_secret"]
