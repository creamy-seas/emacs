...
#+BEGIN_SRC emacs-lisp
(set-email-account! "ilya.antonov24@ntlworld.com"
  '((user-full-name         . "Ilya Antonov (NTLWORLD)")
    (smtpmail-smtp-user     . "ilya.antonov24@ntlworld.com")
...
#+BEGIN_SRC emacs-lisp
(set-email-account! "ilya.antonov@rhul.ac.uk"
  '((smtpmail-smtp-user     . "ilya.antonov@rhul.ac.uk")
...
#+BEGIN_SRC emacs-lisp
(set-email-account! "vgoptics@virginmedia.com"
  '((smtpmail-smtp-user     . "vgoptics@virginmedia.com")
...
#+BEGIN_SRC emacs-lisp
(set-email-account! "mail@ilya-antonov.ru"
  '((smtpmail-smtp-user     . "mail@ilya-antonov.ru")
