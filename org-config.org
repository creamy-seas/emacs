...
|-----------+-----------------------------------------------------+---------------------|
| =C-c c=   | Entering capture mode where templates are available | [[*Capturing templates =C-c c=][Capturing templates]] |
| =C-c C-t= | Add a todo to an org-heading                        | [[*Todo lists =C-c C-t=][Todo lists]]          |


* General Parameters
There are my org files - you probably want to comment them out
#+BEGIN_SRC emacs-lisp
 ...
 #+END_SRC
Emacs/orgmode has an intense feature where you can quickly call upon templates to:
- Generate new files
- Create new org subheadings
- In any file you want
** Capture Templates
Here is a bloated definition of the available templates.
...
*Once again, you will probably want to delete these as they are specific to my config files*
#+BEGIN_SRC emacs-lisp
