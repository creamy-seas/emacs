...
(yas-define-snippets 'org-mode
                     '(("rr" "| | /${1:Process}/ | ${2:=${3:Equipment}=} | ${4:Materials}| | ${5:param-1} | ${6:param-2} | ${7:param-3} | ${8:param-4} |" "recipe-row" nil nil nil "/Users/CCCP/.emacs.d/my-snippets/org-mode/recipe-row" nil nil)
                       ...
                       ("my-drawio-org-insert" "#+ATTR_HTML: :height ${1:200}px\n[[file:drawio/`my/drawio/org/file-name`.svg]]\n$0" "my-drawio-org-insert" nil nil nil "/Users/CCCP/.emacs.d/my-snippets/org-mode/my-drawio-org-insert" nil nil)
