...
#+BEGIN_SRC emacs-lisp 
    (add-hook 'LaTeX-mode-hook (lambda ()
                                 ...
                                 (local-unset-key (kbd "C-c C-n")) ;yasnippet
                                 ))
  ...
  (add-hook 'LaTeX-mode-hook (lambda ()
                               ...
                               ;; (define-key LaTeX-mode-map (kbd "C-c C-p") (function previous-error))
...
#+BEGIN_SRC emacs-lisp 
  (use-package magit
    :ensure t
    ;; :init
    ;; (global-set-key (kbd "C-x C-m") (function magit-status))
)  
 #+END_SRC
* Org mode
...
#+BEGIN_SRC emacs-lisp 
  (setq org-todo-keywords '((sequence "TODO(t)" "STARTED(s)" "|" "DONE(d)")
                            (sequence "FAILED(f)" "|" "GOOD(g)")
                            (sequence "TUTORING(l)" "SCHOOLS(s)" "PHD(p)" "|" "BRYAN(b)")))
...
#+BEGIN_SRC emacs-lisp 
  (setq org-capture-templates
        '(("s" "Screencast" entry
           (file "~/creamy_seas/syncFiles/orgfiles/i.org") "* %?\n%i\n")
          ("l" "LukeSmith entry"
...
#+BEGIN_SRC emacs-lisp 
 ...
 #+END_SRC
*** python3 (the way to handle long scripts)
#+BEGIN_SRC emacs-lisp
...
#+BEGIN_SRC emacs-lisp 
 ...
 #+END_SRC
** collapse blocks of text [hideshow]
h j k l - hiding
a s d g - showing
#+BEGIN_SRC emacs-lisp 
  ...
  (add-hook 'python-mode-hook (lambda ()
                                (define-key elpy-mode-map (kbd "C-c C-h C-a") (function hs-hide-all))
                                (define-key elpy-mode-map (kbd "C-c C-h C-s") (function hs-hide-level))
                                (define-key elpy-mode-map (kbd "C-c C-h C-d") (function hs-hide-block))
                                (define-key elpy-mode-map (kbd "C-c C-h C-t") (function hs-toggle-hiding))
                                (define-key elpy-mode-map (kbd "C-c C-h C-h") (function hs-show-all))
                                (define-key elpy-mode-map (kbd "C-c C-h C-j") (function hs-show-block))
                                (define-key elpy-mode-map (kbd "C-c C-h a") (function hs-hide-all))
                                (define-key elpy-mode-map (kbd "C-c C-h s") (function hs-hide-level))
                                (define-key elpy-mode-map (kbd "C-c C-h d") (function hs-hide-block))
                                (define-key elpy-mode-map (kbd "C-c C-h t") (function hs-toggle-hiding))
                                (define-key elpy-mode-map (kbd "C-c C-h h") (function hs-show-all))
                                (define-key elpy-mode-map (kbd "C-c C-h j") (function hs-show-block))
                                ))
 #+END_SRC
** hide modes
#+BEGIN_SRC emacs-lisp
...
#+BEGIN_SRC emacs-lisp
  (use-package elfeed
    ...
    (setq-default elfeed-search-filter "+unread + boomer")
...
#+BEGIN_SRC emacs-lisp
  ...
  (defhydra hydra-elfeed (global-map "<f5>")
    ""
    ("b" (elfeed-search-set-filter "+prog") "programming")
...
*** collapse by Default
#+BEGIN_SRC emacs-lisp 
  ;; (setq mp/ibuffer-collapsed-groups (list "Default" "*Internal*"))
