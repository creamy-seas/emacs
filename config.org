...
#+BEGIN_SRC emacs-lisp 
  (custom-set-faces
   ...
   '(ein:cell-heading-1 ((t (:inherit ein:cell-heading-3 :foreground "cornflower blue" :weight bold :height 1.1))))
   '(ein:cell-heading-2 ((t (:foreground "cornflower blue" :weight bold :height 1))))
