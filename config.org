...
** Inkscape
#+BEGIN_SRC emacs-lisp 
  (defun inkscape-generate ()
    "Reads the current line and launches an inkscape document under this name"
    (interactive)
    ...
    (let* (;; a - generate filename
          ...
          (inkscape-dir (concat (expand-file-name (TeX-master-directory)) "/images_inkscape"))
      ...
      ;; 3 - inset image snippet
      (setq temp-file-name-for-snippet file-name)
      (delete-region (line-beginning-position) (line-end-position))
      (yas/insert-by-name "ilya-inkscape-generate-snippet")
      ))
