...
#+BEGIN_SRC emacs-lisp
  ...
  ;;   (minibuffer-message "completed stage 1")


     ;;4) close this buffer window
  ;;   (kill-buffer (get-buffer "卍 Exterminating 卍"))
     ;;(ignore-errors(TeX-run-TeX "jew_process" command-script (TeX-master-file)))
  ...
  (defun test ()
    "test"
    (interactive)
    (minibuffer-message (ilya_expand-latex-command "%a")))
