...
#+BEGIN_SRC emacs-lisp 
  (defun ilya-pyenv-nn ()
    ...
    (interactive)
    (progn
      (pyvenv-activate "~/creamy_seas/sync_files/python_vi/nn_vi")
  ...
  (defun ilya-pyenv-mac ()
    ...
    (interactive)
    (progn
      (pyvenv-activate "~/creamy_seas/sync_files/python_vi/mac_vi")
      (setq elpy-rpc-python-command "python3.7")
      (setq python-shell-interpreter "python3.7"
            python-shell-interpreter-args "-i")
      (pyvenv-restart-python))
...
#+BEGIN_SRC emacs-lisp
  (use-package pyenv-mode
    ...
    (if (file-exists-p "~/.macbook_localiser")
        (ilya-pyenv-mac)
      (pyvenv-activate "~/creamy_seas/sync_files/python_vi/arch_vi")))
#+END_SRC
