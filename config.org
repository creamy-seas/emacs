...
a pdf (=-pdf=) file is generated and automatically checked (=-pvc=) for changes using the supplied file (=%s=)

it is set to the default choice
#+BEGIN_SRC emacs-lisp 
  (add-hook 'LaTeX-mode-hook (lambda ()
                               (push
                                '("gen_ilya" "latexmk -pdf -pvc %s" TeX-run-TeX nil t
...
#+BEGIN_SRC emacs-lisp
  ...
  (setq TeX-view-program-list
        '(("SkimViewer" "/Applications/Skim.app/Contents/SharedSupport/displayline -b %n %o %b")))
