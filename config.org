...
#+BEGIN_SRC emacs-lisp 
  (setq org-capture-templates
        '(
          ...
          ("e2" "2am session" entry (id "bryan-plan")
           "** BRYAN %^{project}: %^{stuff-to-be-done}\n%^T")
...
#+BEGIN_SRC emacs-lisp 
  (custom-set-faces
   ...
   '(header-line ((t (:foreground "aquamarine2" :background "#2d3743"))))
   '(ein:notification-tab-normal ((t (:inhert header-line))))
    '(ein:notification-tab-selected ((t (:inhert header-line :foreground "tan1"))))
   '(ein:cell-heading-1 ((t (:inherit ein:cell-heading-2 :foreground "cornflower blue" :weight bold :height 1.1))))
   '(ein:cell-heading-2 ((t (:inherit ein:cell-heading-3 :foreground "MediumPurple2" :weight bold :height 1.1))))
...
#+BEGIN_SRC emacs-lisp 
  (use-package ein
    ...
    (custom-set-variables
     '(ein:jupyter-default-notebook-directory "/Users/CCCP/creamy_seas/2am/adv3_video/python"))
     ;; '(ein:polymode t))
    :config
    (define-key ein:notebook-mode-map (kbd "C-:") (function iedit-mode))
    (define-key ein:notebook-mode-map (kbd "TAB") (function ein:completer-complete)))
...
#+BEGIN_SRC emacs-lisp
  ...
  (defhydra hydra-elfeed (global-map "<f5>")
    ...
    ("a" (elfeed-search-set-filter "+unread") "unread")
