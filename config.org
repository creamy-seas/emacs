...
*** arch
=venv= comes with the newest 3.7 python package installation.
** setup python virtual environment

1) go to directory and run =python3 -m venv NAME= to create virtual environment (=python -m venv NAME) on arch
